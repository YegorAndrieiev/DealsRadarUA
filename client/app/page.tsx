      ...
      <div className="w-full max-w-2xl text-center space-y-8">
        ...
        <div className="space-y-3">
          ...
          <p className="max-w-md mx-auto text-base text-zinc-600 dark:text-zinc-400">
            Миттєвий пошук товарів на Rozetka, OLX та Prom. Порівнюйте ціни, знаходьте б/у пропозиції без реклами та спаму.
          </p>
        </div>
        {/* Форма поиска */}
        <form action="/search" method="GET" className="relative mt-8 max-w-xl mx-auto">
